 ...
 * The upload lands here in ~1-2s (Phase 1) instead of after the full ~30s, so
 * the user always has a clear "we've got your file, it's being processed" state
 * — with a retry when processing failed.
 */
