...
function categoryIconTone(id: CategoryId): CSSProperties {
  ...
  if (id === "conversation") return { background: TOKEN.brand.purpleBg, color: TOKEN.brand.purpleInk };
  if (id === "limits") return { background: TOKEN.semantic.attention.bgSoft, color: TOKEN.semantic.attention.ink };
  return { background: TOKEN.surface.surface2, color: TOKEN.ink.slate };
}
function areaIconTone(id: AreaId): CSSProperties {
  ...
  if (["personality", "conversation", "approach"].includes(id)) return { background: TOKEN.brand.purpleBg, color: TOKEN.brand.purpleInk };
