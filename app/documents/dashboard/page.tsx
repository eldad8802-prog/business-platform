...
export default function Dashboard() {
  ...
  return (
    <div dir="rtl">
      <DocumentsHeader title="דוחות" />

      <main style={pageMain}>
        <section style={hero}>
          <div style={heroKicker}>מרכז דוחות פיננסיים</div>
          <h1 style={heroTitle}>הכנסות מול הוצאות</h1>
          <p style={heroSubText}>
            סכומים, יתרה, וקטגוריות — עם פעולה מהירה לרואה החשבון.
          </p>
        </section>
        ...
        {loading ? <div style={emptyState}>טוען דוח...</div> : null}
