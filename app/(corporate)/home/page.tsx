...
const SCREENS = [
  ...
  {
    src: "/landing/conversations.webp",
    title: "כל הוואטסאפ העסקי במקום אחד",
    body: "כל השיחות עם הלקוחות בוואטסאפ מרוכזות ב-Dubiz — רואים מי כתב, מה ביקש ומה עוד לא ענית, והבוט אפילו מכין לך טיוטת תשובה. שום פנייה לא נופלת בין הכיסאות, גם כשעמוסים.",
    alt: "מסך השיחות של Dubiz — שיחות וואטסאפ עם לקוחות מרוכזות במקום אחד",
  },
  {
