    ...
    <CorporateContainer className="py-12 sm:py-16">
      ...
      <div className="mt-10 space-y-10">
        <section className="max-w-3xl">
          <h2 className="text-lg font-bold text-gray-900">מי אנחנו</h2>
        ...
        <section className="max-w-3xl">
          <h2 className="text-lg font-bold text-gray-900">מה Dubiz עושה</h2>
          <p className="mt-3 text-sm leading-7 text-gray-600 sm:text-base">
        ...
        <section className="max-w-3xl">
          <h2 className="text-lg font-bold text-gray-900">למי זה מתאים</h2>
          <p className="mt-3 text-sm leading-7 text-gray-600 sm:text-base">
        ...
        <section className="max-w-3xl rounded-[24px] bg-white p-6 shadow-sm sm:p-7">
          <h2 className="text-lg font-bold text-gray-900">על PRO MAX GROUP</h2>
          <p className="mt-3 text-sm leading-7 text-gray-600 sm:text-base">
