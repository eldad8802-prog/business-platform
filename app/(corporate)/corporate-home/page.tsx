...
const CAPABILITIES = [
  {
    icon: "💬",
    title: "שיחות ולקוחות",
    body: "ריכוז הפניות והשיחות מול הלקוחות במקום אחד, כדי שלא תפספס פניה ותדע מה מצב כל לקוח.",
  },
  {
    icon: "📄",
  ...
  },
  {
    icon: "📦",
    title: "מלאי ורכש",
    body: "מעקב אחר פריטים, מלאי ומספקים אחרים, כדי לשמור על תמונה מעודכנת של מה שיש ומה שצריך להזמין.",
  },
  {
    icon: "✨",
    title: "תובנות והמלצות פעולה",
    body: "סיקום של מה שקורה בעסק והמלצות פעולה שמסייעות לך להתמקד במשימות החשובות.",
  },
];
  ...
  return (
    <CorporateContainer className="py-12 sm:py-16">
      <section className="text-center">
        <span className="inline-flex items-center gap-2 rounded-full border border-[#bbf7d0] bg-[#f0fdf4] px-3 py-1 text-xs font-semibold text-[#166534]">
          מערכת הפעלה לעסק
        </span>

        <h1 className="mx-auto mt-5 max-w-3xl text-3xl font-extrabold leading-tight text-gray-900 sm:text-5xl">
          Dubiz — מערכת ההפעלה לעסק שלך.
        </h1>

        <p className="mx-auto mt-5 max-w-2xl text-base leading-7 text-gray-600 sm:text-lg">
          Dubiz מרכזת את הניהול היומיומי של העסק במקום אחד — שיחות ולקוחות,
          מסמכים וחשבוניות, מלאי ורכש, ולצידם תובנות והמלצות שעוזרות לך
        ...
        <div className="mt-8 flex justify-center">
          <Link
            href="/login"
            className="rounded-2xl bg-[#1f7a5a] px-6 py-3.5 text-sm font-semibold text-white shadow-sm transition active:scale-[0.99]"
          >
            כניסה למערכת
          </Link>
        </div>
