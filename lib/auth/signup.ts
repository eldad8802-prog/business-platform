 ...
 * decide what the owner sees next, does not send mail, and does not raise
 * events. Those are separate concerns with separate failure modes, and folding
 * them in here would mean a mail outage could cost someone their signup.
 *
...
import { EmailAlreadyRegisteredError, type NormalizedSignup } from "./signup-identity";
