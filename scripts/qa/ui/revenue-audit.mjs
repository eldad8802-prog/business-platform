...
const ROUTES = [
  ["coupon-detail-notfound", "/revenue/coupons/00000000-0000-0000-0000-000000000000", false],
...
async function measure(page) {
  return page.evaluate(() => {
    ...
    return {
      ...
      // R0.2: the redemption secret must never reach a rendered surface.
      tokenInDom: /qrValue|"token"/.test(document.documentElement.innerHTML),
